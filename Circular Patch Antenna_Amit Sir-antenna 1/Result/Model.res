...
lifetime=s:rebuild
result=s:1
files=s:D:\FINAL YEAR PROJECT\Circular Patch Antenna_Amit Sir-antenna 1\Result\Axial RatioTheta=0,Max. Value.rd1
...
xlabel=s:Phi / Degree
ylabel=s:dB
title=s:Farfield  Axial Ratio (Theta=0)
...
lifetime=s:surviveparchange
result=s:1
treepath=s:Tables\1D Results\Axial RatioTheta=0,Max. Value
files=s:Axial RatioTheta=0,Max. Value.rt1
files=s:Axial RatioTheta=0,Max. Value.rd1
