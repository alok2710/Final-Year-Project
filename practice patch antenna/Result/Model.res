...
result=s:1
parametric=s:P
treepath=s:1D Results\Port Information\ZRenormCalc_1(1)_reference_modern
files=s:ZRenormCalc_1(1)_reference_modern
title=s:Original impedance used for renorm
...
result=s:1
parametric=s:P
treepath=s:1D Results\Port Information\ZRenormCalc_1(1)_target_modern
files=s:ZRenormCalc_1(1)_target_modern
title=s:Original impedance used for renorm
