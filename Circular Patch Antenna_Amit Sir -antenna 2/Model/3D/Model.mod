...
'@ transform: translate component1:square path1

'[VERSION]2016.1|25.0.2|20160226[/VERSION]
With Transform 
     .Reset 
     .Name "component1:square path1" 
     .Vector "0", "0", "-1.635" 
     .UsePickedPoints "False" 
     .InvertPickedPoints "False" 
     .MultipleObjects "False" 
...
'@ boolean add shapes: component1:Rectangle Patch_1, component1:square path1

'[VERSION]2016.1|25.0.2|20160226[/VERSION]
Solid.Add "component1:Rectangle Patch_1", "component1:square path1" 
